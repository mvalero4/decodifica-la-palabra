...
let bd = new Array();
bd[0] = ['PERA', 'BANANA', 'NARANJA', 'MELON', 'SANDIA','MANDARINA', 'KIWI', 'FRESA'];
bd[1] = ['PIANO', 'GUITARRA', 'VIOLIN', 'BAJO', 'TROMPETA', 'SAXOFON', 'BATERIA', 'VIOLONCHELO'];
bd[2] = ['LEON', 'GALLINA', 'PERRO', 'LEOPARDO', 'MURCIELAGO', 'MONO', 'ELEFANTE', 'NUTRIA'];
bd[3] = ['ARGENTINA', 'PERU', 'CHILE', 'COLOMBIA', 'ESPAÑA', 'MEXICO', 'ECUADOR', 'MEXICO'];
bd[4] = ['FUTBOL', 'BALONCESTO', 'BOXEO', 'NATACION', 'TENIS', 'GOLF', 'CICLISMO', 'PATINAJE', 'CROSSFIT', 'RUNNING'];
bd[5] = ['MARIA', 'PEDRO', 'MANUEL', 'MAURICIO', 'CARLOS', 'JULIAN', 'CARMEN', 'JOSE', 'ANTONIO', 'ALBERTO'];
bd[6] = ['ROJO', 'VERDE', 'AMARILLO', 'AZUL', 'NEGRO', 'BLANCO', 'MORADO', 'GRIS', 'ROSA', 'NARANJA'];
//categorías
